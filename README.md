...
### Considering the comment from last year's chair "I want you to gain international competitiveness as your next goal.", we decided to write this README.md in Enlish. 
- Wiki (Github)  
...
Please check [the development timeline page](https://github.com/jphacks/D_2002/wiki/Development-Timeline) on the wiki.
